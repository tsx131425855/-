  ...
  <div class="package">
    ...
    <template>
      ...
      >
        ...
        <el-table-column fixed align="center" prop="order_sn" min-width="160" label="订单编号" />
        <el-table-column fixed align="center" min-width="160" prop="user_nickname" label="用户昵称" />
        <el-table-column align="center" prop="user_tel" min-width="110" label="用户账号" />
        <el-table-column align="center" min-width="160" prop="store_name" label="商家名称" />
        <el-table-column align="center" prop="amount" min-width="120" label="订单总金额" />
        <el-table-column align="center" prop="amount_pay" min-width="120" label="微信支出金额" />
        <el-table-column align="center" prop="fee" label="手续费" />
        <el-table-column align="center" prop="balance" min-width="120" label="余额支出金额" />
        <el-table-column align="center" prop="gold_coin" min-width="120" label="金币使用数" />
        <el-table-column align="center" prop="coupon" min-width="120" label="优惠券抵扣金额" />
...
// 提现明细
/* eslint-disable */
import { serviceOrder, exportServiceOrder } from "@/api/finance";
    ...
    exportExcel() {
      ...
      this.$confirm("请确认筛选条件是否符合", "提示", {
        ...
        .then(() => {
          ...
          //开启新下载窗口
          window.open(exportServiceOrder(data));
        })
        .catch(res => {
          console.log(res);
        });
