  ...
  <div class="package">
    ...
    <template>
      ...
      >
        ...
        <el-table-column align="center" prop="user_tel" width="110" label="用户账号" />
        <el-table-column align="center" prop="store_name" width="100" label="商家名称" />
        <el-table-column align="center" prop="store_town" width="100" label="地区" />
        ...
        <!-- <el-table-column align="center" prop="is_service" label="是否申请售后"></el-table-column>
        <el-table-column align="center" prop="return_balance" label="退余额"></el-table-column>
        <el-table-column align="center" prop="return_money" label="退微信"></el-table-column>
        <el-table-column align="center" prop="return_fee" label="退手续费"></el-table-column>
...
// 提现明细
/* eslint-disable */
import { preferential, exportPreferential } from "@/api/finance";
  ...
  methods: {
    ...
    exportExcel() {
      ...
      this.$confirm("请确认筛选条件是否符合", "提示", {
        ...
        .then(() => {
          ...
          //开启新下载窗口
          window.open(exportPreferential(data));
        })
        .catch(res => {
          console.log(res);
        });
    ...
    saveData(bool) {
      ...
      if (bool) {
        // 为true时为保存， 反之取出
        let data =
          JSON.parse(sessionStorage.getItem("preferential_condition")) || {};
        ...
        sessionStorage.setItem("preferential_condition", JSON.stringify(data));
      } else {
        // 取出缓存中的条件数据
        let data = JSON.parse(sessionStorage.getItem("preferential_condition"));
