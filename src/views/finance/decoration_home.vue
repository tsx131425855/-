  ...
  <div class="package">
    ...
    <template>
      ...
      >
        ...
        <el-table-column fixed align="center" prop="user_nickname" min-width="140" label="用户昵称" />
        <el-table-column align="center" prop="user_tel" min-width="110" label="用户账号" />
        <el-table-column align="center" prop="store_name" min-width="160" label="效果图名称" />
        <el-table-column align="center" prop="amount" min-width="120" label="订单金额" />
        ...
        <el-table-column align="center" prop="status_text" min-width="120" label="订单状态" />
        <el-table-column align="center" prop="update_time" min-width="160" label="订单更新时间" />
        <el-table-column align="center" prop="is_service" min-width="120" label="是否申请售后" />
...
// 提现明细
/* eslint-disable */
import { decoration_home, exportDecorationHome } from "@/api/finance";
    ...
    exportExcel() {
      ...
      this.$confirm("请确认筛选条件是否符合", "提示", {
        ...
        .then(() => {
          ...
          //开启新下载窗口
          window.open(exportDecorationHome(data));
        })
        .catch(res => {
          console.log(res);
        });
